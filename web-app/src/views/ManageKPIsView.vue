...
export default {
    ...
    setup() {
        ...
        const createScopeMemo = async () => {
            await useCreateEMOKPI(form.value);
            delayRefetch();
            closeModal();
        };

        const updateScopeMemo = async () => {
            await useUpdateEMOKPI(form.value.kod, form.value);
            delayRefetch();
            closeModal();
        };
        ...
        const confirmDelete = async () => {
            if (IdToDelete.value) {
                await useDeleteEMOKPI(IdToDelete.value.kod);
                delayRefetch();
                closeDeleteModal();
            }
        };
